...
// Source: github.com/modernice/goes/command (interfaces: Command,Encoder,Bus,Context)
...
import (
	...
	done "github.com/modernice/goes/command/done"
	io "io"
	reflect "reflect"
)
...
func (m *MockContext) Command() command.Command {
	m.ctrl.T.Helper()
...
func (m *MockContext) Done(arg0 context.Context, arg1 ...done.Option) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
...
func (mr *MockContextMockRecorder) Done(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Done", reflect.TypeOf((*MockContext)(nil).Done), varargs...)
}
