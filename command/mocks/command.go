...
// Source: github.com/modernice/goes/command (interfaces: Command,Encoder,Bus,Handler)
...
func (m *MockHandler) Handle(arg0 command.Context, arg1 command.Command) error {
	m.ctrl.T.Helper()
