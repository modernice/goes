...
func NewList(id uuid.UUID) *List {
	...
	// TODO: register the event appliers for ListCreated, ItemAdded, and ItemCompleted.
...
func (l *List) Create(title string) error {
	...
	// TODO: record the ListCreated event.
	return nil
}
...
func (l *List) AddItem(title string) error {
	...
	// TODO: record the ItemAdded event.
	return nil
}
...
func (l *List) CompleteItem(title string) error {
	...
	// TODO: record the ItemCompleted event.
	return nil
}
