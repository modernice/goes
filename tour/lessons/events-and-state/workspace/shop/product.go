...
func NewProduct(id uuid.UUID) *Product {
	...
	// TODO: register the remaining rename, price, and stock event appliers.
...
func (p *Product) Rename(name string) error {
	...
	// TODO: raise the ProductRenamed event.
	return nil
}
...
func (p *Product) ChangePrice(price int) error {
	...
	// TODO: raise the PriceChanged event.
	return nil
}
...
func (p *Product) AdjustStock(quantity int, reason string) error {
	...
	// TODO: raise the StockAdjusted event.
	return nil
}
